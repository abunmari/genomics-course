...
### Counts of confirmed cases & deaths by country (03.11.20)
```{r}
report_03_11_2020 %>% 
...
### Top 10 counries for death (03.11.20)
```{r}
report_03_11_2020 %>% 
  group_by(Country_Region) %>% 
...
### Plot - Top 10 countries with total deaths (3.11.20)
...
### Bargraph - Top 10 states with confirmed cases (03.11.20)
```{r}
...
### Bargraph - Top 10 states with deaths (03.11.20)
```{r}
...
### Bargraph - Top 10 states with confirmed cases (09.13.20)
```{r}
...
### Bargraph - Top 10 states with deaths (09.13.20)
```{r}
